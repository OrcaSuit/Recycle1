package com.example.part000recyclerviewcardview;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for(int i = 0 ; i < 100 ; i++){
            ...
            student.setName("CETI"+i);
            student.setNumber("201600" + i);
    ...
    private class ListViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        public void bindStudent(Student s) { mStudent = s; }

        @Override
        public void onClick(View v) {
            Toast.makeText(getApplicationContext(), mStudent.getName()+ "is selected!!!", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    private class ListAdapter extends RecyclerView.Adapter<ListViewHolder>{
        ...
        public void onBindViewHolder(ListViewHolder holder, int position) {
            ...
            holder.mName.setText(student.getNumber());
            holder.mDepart.setText(student.getDepartment());
        }
